    ...
    public override bool[,] LegalMoves()
    {
        ...
        if (isPieceWhite)
        {
            ...
            if (CurrentPositionX != 0 && CurrentPositionY != 7)
            {
                ...
                p1 = ChessBoardManager.Instance.ChessPieces[CurrentPositionX - 1, CurrentPositionY + 1];
            ...
            {
                p1 = ChessBoardManager.Instance.ChessPieces[CurrentPositionX, CurrentPositionY + 1];
                if (p1 == null)
                {
            ...
            {
                p1 = ChessBoardManager.Instance.ChessPieces[CurrentPositionX, CurrentPositionY + 1];
                p2 = ChessBoardManager.Instance.ChessPieces[CurrentPositionX, CurrentPositionY + 2];
                if (p1 == null && p2 == null)
                {
